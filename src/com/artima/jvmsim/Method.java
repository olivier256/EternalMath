...
/**
 * This class represents the method being executed by the JVM simulation and
 * performs the actual interpreting of the bytecodes.
 *
 * @author Bill Venners
 */
class Method {
	...
	Method(StackFrame sf, byte[] code, ExceptionTableEntry[] exceptionTable, ConstantPoolEntry[] constantPool) {
	...
	private int getIntOperand(int codeIndex) {
		...
		int theInt = (intByte1 << 24) | ((intByte2 & 0xff) << 16) | ((intByte3 & 0xff) << 8) | (intByte4 & 0xff);
		return theInt;
	}
