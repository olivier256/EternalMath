...
/**
 * GridSnapLayout lays out components in a grid that can have columns of varying
 * width. This is not a very general purpose layout manager. It solves the
 * specific problem of getting all the information I want to display about the
 * stack and method areas in a nice grid. Because some columns of info need more
 * room than others, and space is limited on a web page, I needed to be able to
 * specify varying widths of columns in a grid.
 *
 * @author Bill Venners
 */
